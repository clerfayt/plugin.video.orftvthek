      ...
      function DownloadFragments($cc, $manifest, $opt = array())
        {
          ...
          //Changed by ST, 2015-03-18, since filenames were too long (> 255 characters)
          /*OLD*///$this->baseFilename .= "Seg" . $segNum . "-Frag";
          /*NEW*/  $this->baseFilename = md5($this->baseFilename) . "Seg" . $segNum . "-Frag";
